#!/usr/bin/env python3
"""Quick data generation for demo setup - 10k subscribers with same logic as full version."""
...
def main():
    print("=" * 60)
    print("Media Company Churn Demo - Quick Data Generation (10k)")
    print("=" * 60)
